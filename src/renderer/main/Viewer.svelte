<script lang="ts">
    ...
    const exitFullscreen = () => {
        ...
        window.api.send("toggle-fullscreen", {fullscreen:$appState.isFullscreen})
    }
...
<div class="viewport" class:dragging={$appState.dragging} class:pinned={$appState.isPinned} class:mouse={$appState.isMouseOnly} class:history-open={$appState.isHistoryOpen} class:full={$appState.isFullscreen}>
    ...
    <div class="container">
        ...
        <div class="image-container can-focus" on:dragover={e => e.preventDefault()} on:drop={onDrop} role="button" tabindex="-1">
            ...
            <div bind:this={imageArea} class="image-area clickable current" on:mousedown={onImageAreaMousedown} on:wheel={imageTransform.onWheel} on:keydown={handelKeydown} role="button" tabindex="-1">
